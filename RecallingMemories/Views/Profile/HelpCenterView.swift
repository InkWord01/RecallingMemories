        ...
        HelpCategory(
            ...
            items: [
                ...
                HelpItem(
                    ...
                    answer: """
                    点工具栏的相册图标，最多一次挂载 9 张照片或视频。视频建议 30 秒以内，过长会占用较多空间。
                    附件保存在 App 沙盒中，删除该条记忆时附件会一并清理。
                    """
                ),
                HelpItem(
        ...
        HelpCategory(
            ...
            items: [
                ...
                HelpItem(
                    ...
                    answer: """
                    MVP 阶段暂不同步。只有文字、时间、地点、人物标签、情绪等元数据会上云。
                    后续版本会接入 CloudKit Asset 让媒体也能跨设备，届时会再次征得你的同意。
                    """
                ),
                HelpItem(
