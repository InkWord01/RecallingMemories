...
详细产品文档见 [`init.txt`](./init.txt)。**Mac 端运行与发布步骤见 [`RUN.md`](./RUN.md)；项目交付清单见 [`HANDOFF.md`](./HANDOFF.md)；视觉语言规范见 [`docs/design-guide.md`](./docs/design-guide.md)；云端打包发版见 [`docs/release.md`](./docs/release.md)。**
